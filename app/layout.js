  ...
  return (
    <html lang="en">
      ...
      <body className='mx-[1.25rem] phone:mx-[1.25rem] tablet:mx-[2.5rem] laptop:mx-[5rem] pt-8 relative'>
        <div className="h-full w-[1px] bg-[#BBBBBB] absolute top-0 left-1/3 -translate-x-1 -z-10"></div>
        <div className="h-full w-[1px] bg-[#BBBBBB] absolute top-0 right-1/3 translate-x-1 -z-10"></div>
        <NavBar/>
        {children}
        <Footer/>
      </body>
